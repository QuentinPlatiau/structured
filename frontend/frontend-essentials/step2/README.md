...
- Installation de Bootstrap et dépendances :  npm i bootstrap popper
- Inclure le chargement du CSS de Bootstrap dans la page : import 'bootstrap/dist/css/bootstrap.min.css';
